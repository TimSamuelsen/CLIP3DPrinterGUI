...
/// <para>For monochrome cameras, each pixel requires two bytes.</para>
/// <para>For color cameras, each pixel requires two bytes for blue followed by two bytes for green followed by
/// two bytes for red (BBGGRRBBGGRRBBGGRR...). Therefore, each color pixel requires six bytes.</para>
/// </summary>
